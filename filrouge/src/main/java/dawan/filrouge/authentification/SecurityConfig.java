package dawan.filrouge.authentification;
...
import dawan.filrouge.service.UserService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.authenticationProvider(provider)
		.authorizeRequests()
		.antMatchers("/formats").permitAll()
		.antMatchers(HttpMethod.GET,"/format/*").hasAnyAuthority("READ","SUPER")
		.antMatchers(HttpMethod.POST,"/format").hasAuthority("CREATE")
